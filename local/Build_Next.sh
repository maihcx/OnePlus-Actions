...
echo "kernel_name: -$adv-ksn-vieos"
...
sed -i '$s|echo "\$res"|echo "-$adv-ksn-vieos"|' kernel_platform/common/scripts/setlocalversion
sed -i '$s|echo "\$res"|echo "-$adv-ksn-vieos"|' kernel_platform/msm-kernel/scripts/setlocalversion
sed -i '$s|echo "\$res"|echo "-$adv-ksn-vieos"|' kernel_platform/external/dtc/scripts/setlocalversion
